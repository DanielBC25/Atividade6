...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<Pessoa> pessoas = new ArrayList<Pessoa>();
			...
			Estudante estudante01 = new Estudante("Matheus", "Wall St.");
			estudante01.addCursoNota("Biologia", 9);
			estudante01.addCursoNota("informatica", 6);
			
			Estudante estudante02 = new Estudante("Antonio", "Main st.");
			estudante02.addCursoNota("Matematica", 8);
			estudante02.addCursoNota("Ciencia", 9);
			estudante02.addCursoNota("Informatica", 9);
			
			Estudante estudante03 = new Estudante("Luiz", "Second st.");
			estudante03.addCursoNota("Historia", 8);
			estudante03.addCursoNota("Matematica", 9);
			estudante03.addCursoNota("Informatica", 9);
			estudante03.addCursoNota("ingles", 9);
			pessoas.add(estudante01);
			pessoas.add(estudante02);
			pessoas.add(estudante03);

			Professor  professor01 = new Professor("Wagner", "Fourth st.");
			professor01.addCurso("matematica");
			professor01.addCurso("biologia");
			
			Professor professor02 = new Professor("Lucas", "First st.");
